...
public class AdminController {
    ...
    @FXML
    public void redirectToAffectationRespoEtage() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/reservation/Views/InterfacesSuperUser/affectation_respo_etage.fxml")
            );
            Parent root = loader.load();

            Stage stage = new Stage();
            stage.setTitle("Affectation Responsable à un Étage");
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Erreur");
            alert.setHeaderText("Impossible d'ouvrir la fenêtre d'affectation");
